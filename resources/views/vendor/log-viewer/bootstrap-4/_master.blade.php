...
<head>
    ...
    <title>Logs - Divulga WhatsApp</title>
    {{-- Styles --}}
...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="{{ route('log-viewer::dashboard') }}" class="navbar-brand mr-0">
            <i class="fa fa-fw fa-book"></i> Gestão de Logs
        </a>
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            <p class="text-muted pull-left">
                DivulgaWhatsApp - <span class="badge badge-info">V{{ log_viewer()->version() }}</span>
            </p>
            <p class="text-muted pull-right">
                Powered by APIBrasil <i class="fa fa-heart"></i> <sup>&copy;</sup>
            </p>
        </div>
    </footer>
